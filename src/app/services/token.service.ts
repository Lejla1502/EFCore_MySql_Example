...
export class TokenService {
  ...
  //The token service will handle the local validation, storage and retrieval of the tokens and key user details. 
  //This is a critical service to keep the angular app aware of the authentication related data.
