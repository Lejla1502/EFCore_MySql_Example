...
/*the guard is also checking if the token is expired and doing a silent refresh using the refresh token,
in case the silent refresh failed, it means either the refresh token was revoked or got expired and therefore the user has to login again. */
